...
public class Maps {
    public static void main(String[] args) {
        ...
        System.out.println(note_elevi.get("Gigel")); //null - multimea vida//elementul nu mai este gasit

        //declaram si initializam cu valori
        //map nu este returnat ordonat
        ...
        //luni.replace(); //asa putem folosi metode
